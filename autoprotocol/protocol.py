...
class Protocol(object):
    ...
    def autopick(self, source, dests, dataref, min_count=1):
      """
      ...
      dataref : str
          Data reference for data generated by this instruction
      ...
      if isinstance(dests, Well) or isinstance(dests, str):
        dests = [dests]
      self.instructions.append(Autopick(source, dests, dataref, min_count))
