...
ECHO384 = ContainerType(
    ...
    capabilities=["liquid_handle", "seal", "spin", "incubate", "dispense", "cover", "provision"],
    shortname="384-echo",
    col_count=24,
...
MICRO2 = ContainerType(
    ...
    cover_types=None,
    seal_types=None,
    capabilities=["liquid_handle", "gel_separate", "gel_purify", "incubate", "spin", "provision"],
    shortname="micro-2.0",
    is_tube=True,
    col_count=1,
    dead_volume_ul=Unit(5, "microliter"),
...
RESSW96HP = ContainerType(
    ...
    cover_types=["universal"],
    seal_types=None,
    capabilities=["liquid_handle", "incubate", "cover", "dispense", "liquid_handle", "provision"],
...
SPL384UVMAX = ContainerType(
    name="SPLUVMax 384-well Crystal-Grade Polystyrene Microplate, Film-Bottom",
    well_count=384,
    well_depth_mm=11.5,
    well_volume_ul=Unit(130, "microliter"),
    well_coating=None,
    sterile=True,
    is_tube=False,
    cover_types=["universal"],
    seal_types=["breathable", "ultra-clear", "foil"],
    capabilities=[
        "pipette",
        "spin",
        "incubate",
    ...
    shortname="384-spl-flat-uv-ps",
    col_count=24,
    dead_volume_ul=Unit(10, "microliter"),
    safe_min_volume_ul=Unit(10, "microliter"),
    vendor="SPL Life Sciences",
    cat_no="SPL-330384",
)

#:
SPL96UVMAX = ContainerType(
    name="SPLUVMax 96-well Crystal-Grade Polystyrene Microplate, Film-Bottom",
    well_count=96,
    well_depth_mm=11.4,
    well_volume_ul=Unit(400, "microliter"),
    well_coating=None,
    sterile=True,
    is_tube=False,
    cover_types=["universal"],
...
_CONTAINER_TYPES = {
    ...
    "384-spl-flat-uv-ps": SPL384UVMAX,
    "96-spl-flat-uv-ps": SPL96UVMAX,
}
