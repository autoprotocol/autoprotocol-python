...
class Protocol(object):
    ...
    def blue_wash(self, container, kind):
        """
        Executes a program on the Bluecat washer.
        ...
        container: Container, str
          Container to wash
        kind: str
          The wash program to execute. One of ("Single96", "Single384", "Evacuate")
        """
        if not isinstance(container, Container):
            raise TypeError("container must be of type Container.")

        self.instructions.append(BlueWash(container, kind))
