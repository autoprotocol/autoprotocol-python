...
_CONTAINER_TYPES = {
    ...
    "384-echo": ContainerType(name="384-well Echo plate",
                              ...
                              safe_min_volume_ul=Unit(15, "microliter")),
    "384-flat-white-white-lv": ContainerType(name="384-well flat-bottom low volume plate",
                                             well_count=384,
                                             well_depth_mm=9.39,
                                             ...
                                             dead_volume_ul=Unit(5, "microliter"),
                                             safe_min_volume_ul=Unit(15, "microliter")),
    "384-flat-white-white-tc": ContainerType(name="384-well flat-bottom low flange plate",
                                             well_count=384,
                                             well_depth_mm=11.43,
    ...
    "384-flat-clear-clear": ContainerType(name="384-well fully clear high binding plate",
                                          well_count=384,
                                          well_depth_mm=11.43,
                                          well_volume_ul=Unit(80.0, "microliter"),
    ...
    "6-flat-tc": ContainerType(name="6-well TC treated plate",
                               well_count=6,
                               well_depth_mm=None,
                               well_volume_ul=Unit(5000.0, "microliter"),
                               well_coating=None,
