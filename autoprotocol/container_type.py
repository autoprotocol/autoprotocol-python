...
_CONTAINER_TYPES = {
    ...
    "96-flat": ContainerType(name="96-well flat-bottom plate",
                             ...
                             col_count=12,
                             dead_volume_ul=25),
    "96-flat-uv": ContainerType(name="96-well flat-bottom UV transparent plate",
                             well_count=96,
                             well_depth_mm=None,
                             well_volume_ul=340.0,
                             well_coating=None,
    ...
    "micro-1.5": ContainerType(name="1.5mL Microcentrifuge tube",
                               ...
                               col_count=1,
                               dead_volume_ul=15),
    "6-flat": ContainerType(name="6-well flat plate",
                               well_count=6,
                               well_depth_mm=None,
                               well_volume_ul=1500.0,
                               well_coating=None,
                               ...
                               col_count=3,
                               dead_volume_ul=15),
    "1-flat": ContainerType(name="1-well flat plate",
                               well_count=1,
                               well_depth_mm=None,
