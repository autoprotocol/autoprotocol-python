...
_CONTAINER_TYPES = {
    ...
    "96-v-kf": ContainerType(name="96-well cone bottom king fisher plate",
                             well_count=96,
                             well_depth_mm=None,
                             ...
                             sterile=False,
                             capabilities=[],
                             shortname="96-cone-kf",
                             is_tube=False,
                             col_count=12,
                             dead_volume_ul=20,
                             safe_min_volume_ul=20),
    "96-deep-kf": ContainerType(name="96-well extended capacity king \
                                fisher plate",
                                well_count=96,
                                well_depth_mm=None,
